...
exports.createCar = async (req, res) => {
  try {
    ...
    logger.error("CREATE CAR ERROR: " + err.message);
...
exports.getCars = async (req, res) => {
  try {
    ...
    logger.error("GET CARS ERROR: " + err.message);
...
exports.getCarById = async (req, res) => {
  try {
    ...
    logger.error("GET CAR ERROR: " + err.message);
...
exports.updateCar = async (req, res) => {
  try {
    ...
    if (req.files?.cars_image) {
      ...
      if (old[0]?.cars_image) {
        await deleteFile("public/" + old[0].cars_image);
      }
    ...
    logger.error("UPDATE CAR ERROR: " + err.message);
...
exports.deleteCar = async (req, res) => {
  try {
    ...
    logger.error("SOFT DELETE CAR ERROR: " + err.message);
