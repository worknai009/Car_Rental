  ...
  return (
    ...
    >
      <Menu menuItemStyles={{ button: { "&:hover": { backgroundColor: "#1f2937" } } }}>
        ...
        {/* Navigation Links */}
        <MenuItem icon={<LayoutDashboard />} component={<Link to="/admin" />}>
          Dashboard
        </MenuItem>

        <p className="text-xs text-gray-500 px-6 py-2 uppercase">Data</p>
        <MenuItem icon={<Car />} component={<Link to="/admin/createcategory" />}>
          Add Categories
        </MenuItem>
        <MenuItem icon={<Car />} component={<Link to="/admin/addcar" />}>
          Add Cars
        </MenuItem>
        <MenuItem icon={<Car />} component={<Link to="/admin/carlist" />}>
          Cars List
        </MenuItem>
        <MenuItem icon={<Users />} component={<Link to="/admin/users" />}>
          Users
        </MenuItem>
        ...
        <p className="text-xs text-gray-500 px-6 py-2 uppercase">LogOut</p>
        <MenuItem icon={<Car />} component={<Link to="/admin/logout" />}>
          Admin Logout
        </MenuItem>
      </Menu>
    </ProSidebar>
